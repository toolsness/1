<div>
    <main class="flex flex-col items-center flex-grow max-w-md py-12 mx-auto md:max-w-lg">
        <h2 class="mb-8 text-2xl font-bold text-gray-800">Business Operator Login</h2>
        <form wire:submit.prevent="login" class="w-full max-w-md">
            ...
            <div class="mb-8 grid grid-cols-[1fr_auto] gap-5 items-center">
                ...
                <div class="relative flex flex-col" x-data="{ showPassword: @entangle('showPassword') }">
                    <input
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div>
                    <a href="{{ route('business-operator.password.request') }}" title="If you have forgotten your password please click here to reset it!" class="text-blue-500 hover:underline hover:uppercase">Forgot Password?</a>
                </div>
            </div>
