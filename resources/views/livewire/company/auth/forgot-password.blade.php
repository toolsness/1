    ...
    <div class="max-w-md w-full">
        ...
        <form wire:submit.prevent="sendResetLink" class="mt-8 space-y-4">
            ...
            <div class="mt-4 text-center">
                {{-- <a href="{{ session('previous_url') }}" class="items-center justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-gray-300">
                    Return to TOP
                </a> --}}
