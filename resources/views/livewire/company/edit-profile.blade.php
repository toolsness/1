<div class="pb-16">
    <div class="container max-w-2xl mx-auto mt-8">
        <h2 class="pb-5 mb-4 text-2xl font-bold text-center">Edit Profile</h2>
        @if(!$isEditing)
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="flex justify-center col-span-2 mb-4">
                    <img src="{{ $profileImage ? Storage::url($profileImage) : asset('placeholder.png') }}" alt="Profile Picture" class="object-cover w-32 h-32 rounded-full">
                </div>
            ...
            <form wire:submit.prevent="confirmUpdate">
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="relative w-32 h-32">
                        ...
                        @else
                            <img src="{{ $profileImage ? Storage::url($profileImage) : asset('placeholder.png') }}" alt="Profile Picture" class="object-contain w-full h-full border border-gray-300 rounded shadow-sm">
                        @endif
            ...
            <div class="relative p-5 mx-auto bg-white border rounded-md shadow-lg top-20 w-96">
                <div class="mt-3 text-center">
                    ...
                    <div class="items-center px-4 py-3">
                        <button wire:click="updateProfile" class="w-full px-4 py-2 text-base font-medium text-white bg-blue-500 rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300">
                            Confirm Update
                        </button>
