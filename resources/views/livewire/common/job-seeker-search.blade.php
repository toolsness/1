    ...
    <main class="flex items-center justify-center px-2 text-black bg-white sm:px-4 md:px-16 sm:py-2 md:py-2">
        <section class="flex flex-col w-full max-w-[889px]">
            ...
            <form wire:submit.prevent="$refresh"
                class="flex flex-col sm:flex-row gap-2 sm:gap-4 justify-between px-2 sm:px-4 py-2 sm:py-3 mb-4 sm:mb-8 w-full max-w-[889px] mx-auto text-sm bg-white rounded-md border border-black">
                    ...
                    <tbody>
                        @foreach ($candidates as $candidate)
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="p-2 sm:p-3">
                                    {{ ucfirst($candidate->qualificationRelation->qualificationCategory->name) }}<br>{{ ucfirst($candidate->qualificationRelation->qualification_name) }}
                                </td>
                                <td class="p-2 sm:p-3">
