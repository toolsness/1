<div class="bg-white py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        <header class="items-center mb-8">
            <h1 class="text-xl font-semibold text-center mb-4 sm:mb-8">Which jobs do you scout for?</h1>
        ...
        <p class="text-xl font-semibold text-black my-6">My Job Listings: <span class="text-red-600">{{ count($jobListings) }}</span></p>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            @foreach ($jobListings as $jobListing)
                <a wire:click.prevent="selectJob({{ $jobListing['id'] }})" href="#"
                    ...
                    <div class="bg-white rounded-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center space-x-2">
                                    <svg class="w-5 h-5 text-gray-500" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="9.78394" cy="9.91987" r="9.44916" stroke="currentColor" stroke-width="0.5" />
                                        <path d="M5.25411 4.964H13.7691V15.845H12.7421V5.952H6.25511V15.897H5.25411V4.964ZM5.91711 9.475H13.1711V10.437H5.91711V9.475ZM5.90411 14.077H13.1971V15.052H5.90411V14.077Z" fill="black" />
                                    </svg>
                                    <span class="text-sm">Language Requirement: {{ $jobListing['japaneseLevel'] }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="mt-12 text-center">
            <button class="px-8 py-3 text-sm text-black bg-white rounded-md border border-black hover:bg-gray-100 transition duration-300"
