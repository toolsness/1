<div class="container px-4 py-8 mx-auto">
    ...
    <div class="mb-4">
        <p class="text-sm">
            ...
            Recommended Slots for This Job Interviews
        </p>
        <p class="text-sm">
            <span class="inline-block w-4 h-4 mr-2 border-2 border-blue-500 rounded-full"></span> Other Available Slots
            ( These Slots time and date may change depending on availability of vacancies )
        </p>
        <p class="text-sm">
    ...
    @if ($selectedDate)
        <h2 class="mb-4 text-xl font-semibold">Please select an interview time</h2>
        <div class="space-y-2">
        ...
        <div class="mt-8 text-center">
            <button wire:click="applyForInterview"
