<section class="bg-white rounded-lg shadow-md border border-black border-solid p-6 max-w-md w-full">
    ...
    <div class="flex flex-col gap-4">
        ...
        {{-- <span class="text-center">
            <a class="text-blue-600" href="{{ route('home', ['viewType' => $viewType === 'student' ? 'company' : 'student']) }}">Click here</a>
            to login to your {{ $viewType === 'student' ? 'company' : 'student' }} account or register as a new member.
        </span> --}}
    </div>
