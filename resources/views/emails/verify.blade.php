...
<body>
    <div class="container">
        ...
        <a href="{{ $verificationUrl }}"
            style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;">Verify
            Email</a>
        ...
        <p>This above verification link will expire in 5 minutes. If the validation link has expired, please register
            again.</p>
